...
const Page = () => {
    ...
    if (isLoading) {
        return <div className="flex items-center justify-center py-12"><Loader2
            className="w-8 h-8 animate-spin text-accent"/></div>;
    }
        ...
        <div className="space-y-6 max-w-5xl">
            ...
            <Tabs defaultValue="general" className="w-full">
                <TabsList className="flex flex-wrap h-auto gap-1 mb-6">
                    ...
                    <TabsTrigger value="logo" className="flex items-center gap-1"><Image
                        className="w-4 h-4"/>Logo</TabsTrigger>
                    <TabsTrigger value="home" className="flex items-center gap-1"><Home
                        className="w-4 h-4"/>Home</TabsTrigger>
                    <TabsTrigger value="services" className="flex items-center gap-1"><Briefcase className="w-4 h-4"/>Services</TabsTrigger>
                    <TabsTrigger value="about" className="flex items-center gap-1"><Info
                        className="w-4 h-4"/>About</TabsTrigger>
                ...
                <TabsContent value="general" className="space-y-6">
                    <Card>
                        <CardHeader><CardTitle className="flex items-center gap-2"><Building className="w-5 h-5"/>Company
                            Name</CardTitle></CardHeader>
                        <CardContent>
                            <Tabs defaultValue="en">
                                <TabsList className="mb-4">
                                    {LANGUAGES.map((lang) => (
                                        <TabsTrigger key={lang.code}
                                                     value={lang.code}>{lang.flag} {lang.label}</TabsTrigger>
                                    ))}
                                </TabsList>
                                {LANGUAGES.map((lang) => (
                    ...
                    <Card>
                        <CardHeader><CardTitle className="flex items-center gap-2"><Phone className="w-5 h-5"/>Contact
                            Information</CardTitle></CardHeader>
                        <CardContent className="space-y-4">
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    <Label>Phone Numbers</Label>
                                    <Button type="button" variant="outline" size="sm" onClick={addPhone}><Plus
                                ...
                                {settings.phones.map((phone, idx) => (
                                    <div key={idx} className="flex gap-2">
                                        ...
                                        <Button type="button" variant="ghost" size="icon"
                                                onClick={() => removePhone(idx)}><X className="w-4 h-4"/></Button>
                                    </div>
                                ))}
                            </div>
                            <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Button type="button" variant="outline" size="sm" onClick={addEmail}><Plus
                                        className="w-4 h-4 mr-1"/>Add</Button>
                                </div>
                                {settings.emails.map((email, idx) => (
                                    <div key={idx} className="flex gap-2">
                                        ...
                                        <Button type="button" variant="ghost" size="icon"
                                                onClick={() => removeEmail(idx)}><X className="w-4 h-4"/></Button>
                                    </div>
                                ))}
                            </div>
                        </CardContent>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <Tabs defaultValue="en">
                                <TabsList className="mb-4">
                                    {LANGUAGES.map((lang) => (<TabsTrigger key={lang.code}
                                                                           value={lang.code}>{lang.flag} {lang.label}</TabsTrigger>))}
                                </TabsList>
                                {LANGUAGES.map((lang) => (
                                    <TabsContent key={lang.code} value={lang.code}>
                                        <Input
                                            value={settings[`address_${lang.code}` as keyof SiteSettings] as string || ""}
                                            onChange={(e) => updateField(`address_${lang.code}` as keyof SiteSettings, e.target.value)}/>
                                    </TabsContent>
                                ))}
                            </Tabs>
                        </CardContent>
                        ...
                        <CardContent>
                            <Tabs defaultValue="en">
                                ...
                                {LANGUAGES.map((lang) => (
                                    <TabsContent key={lang.code} value={lang.code}>
                                        <Input
                                            value={settings[`working_hours_${lang.code}` as keyof SiteSettings] as string || ""}
                                            onChange={(e) => updateField(`working_hours_${lang.code}` as keyof SiteSettings, e.target.value)}
                    ...
                    <Card>
                        <CardHeader><CardTitle className="flex items-center gap-2"><Globe className="w-5 h-5"/>Social
                            Media & Map</CardTitle></CardHeader>
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input value={settings.youtube_url || ""}
                            ...
                            <div className="space-y-2">
                                ...
                                <Input value={settings.map_embed_url || ""}
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="pt-4 border-t">
                                <Label className="text-base font-semibold mb-4 block">Service Cards (Tours, Air Tickets,
                                    Cruises)</Label>
                                <BlockEditor
                            ...
                            <BlockEditor
                                ...
                                renderItem={(item, _index, update) => (
                                    <div className="space-y-4">
                                        ...
                                        <div className="pt-4 border-t">
                                            <Label className="text-sm font-medium mb-3 block">Features (Checkmark
                                                List)</Label>
                                            <FeatureEditor
                                                items={item.features || []}
