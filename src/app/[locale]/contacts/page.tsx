                                    ...
                                    <Card className="hover-lift group">
                                        <CardContent className="p-6">
                                            <div className="flex items-start gap-4">
                                                <div
                                                    className="w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center flex-shrink-0 transition-transform duration-300 group-hover:scale-110">
                                                    ...
                                                    <div className="flex flex-col gap-1">
                                                        {item.values.map((value: string, idx: number) =>
                                                            item.hrefPrefix ? (
                                                                ...
                                                                <p key={idx}
                                                                   className="text-muted-foreground">{value}</p>
                                                            )
                                                        )}
                                                    </div>
                                                </div>
