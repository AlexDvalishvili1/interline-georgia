...
import { useSiteSettings, getContentField, getContentArray, type ValueItem, type StatItem } from "@/hooks/useSiteSettings";
import { getIconComponent } from "@/lib/iconMap";

// Default values when DB is empty
const DEFAULT_VALUES: ValueItem[] = [
  { id: "1", icon: "award", title: { en: "Trust", ru: "Доверие", ka: "ნდობა" }, description: { en: "Building lasting relationships through reliability and honesty.", ru: "Построение долгосрочных отношений через надежность и честность.", ka: "გრძელვადიანი ურთიერთობების დამყარება სანდოობით და პატიოსნებით." } },
  { id: "2", icon: "star", title: { en: "Quality", ru: "Качество", ka: "ხარისხი" }, description: { en: "Delivering exceptional service in every interaction.", ru: "Предоставление исключительного сервиса в каждом взаимодействии.", ka: "განსაკუთრებული მომსახურების მიწოდება ყველა ინტერაქციაში." } },
  { id: "3", icon: "heart", title: { en: "Care", ru: "Забота", ka: "ზრუნვა" }, description: { en: "Putting our clients' needs and satisfaction first.", ru: "Ставим потребности и удовлетворенность клиентов на первое место.", ka: "ჩვენი კლიენტების საჭიროებები და კმაყოფილება პირველ ადგილზეა." } },
];
