            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center mb-6">
                <TabsList className="bg-secondary">
                  <TabsTrigger value="offers" className="transition-all duration-200">{t("offers.tabs.offers")}</TabsTrigger>
                  <TabsTrigger value="promotions" className="transition-all duration-200">{t("offers.tabs.promotions")}</TabsTrigger>
                  <TabsTrigger value="news" className="transition-all duration-200">{t("offers.tabs.news")}</TabsTrigger>
                </TabsList>
...
const PostGrid = ({ posts, language, t }: PostGridProps) => {
  ...
  return (
    <div ref={containerRef as React.RefObject<HTMLDivElement>} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
