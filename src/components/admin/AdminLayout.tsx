...
export const AdminLayout = ({children}: AdminLayoutProps) => {
    ...
    return (
        <div className="min-h-screen flex bg-muted/30">
            ...
            {/* Mobile Header */}
            <div
                className="md:hidden fixed top-0 left-0 right-0 h-16 bg-card border-b border-border z-50 flex items-center px-4 justify-between">
                <Link href="/admin" className="font-heading font-bold text-primary">
                    Interline Admin
                </Link>
            ...
            {/* Main Content */}
            <main className="flex-1 md:p-8 p-4 pt-20 pb-24 md:pt-8 md:pb-8 overflow-auto">{children}</main>
        </div>
    );
};